...
export enum I18nKey {
  ...
  HOME$SELECT_PROJECT_FOLDER = "HOME$SELECT_PROJECT_FOLDER",
  HOME$SELECT_PROJECT_FOLDER_TOOLTIP = "HOME$SELECT_PROJECT_FOLDER_TOOLTIP",
  HOME$CHOOSE_FOLDER = "HOME$CHOOSE_FOLDER",
  HOME$ENTER_ABSOLUTE_PATH = "HOME$ENTER_ABSOLUTE_PATH",
  HOME$SELECTED_PATH = "HOME$SELECTED_PATH",
  HOME$LOCAL_RUNTIME_HELPER_TEXT = "HOME$LOCAL_RUNTIME_HELPER_TEXT",
  HOME$VALIDATE = "HOME$VALIDATE",
  HOME$DIAGNOSE = "HOME$DIAGNOSE",
  HOME$RESTART_REQUIRED = "HOME$RESTART_REQUIRED",
  HOME$RESTART_REQUIRED_MESSAGE = "HOME$RESTART_REQUIRED_MESSAGE",
  HOME$VALIDATION_ERRORS = "HOME$VALIDATION_ERRORS",
  HOME$VALIDATION_WARNINGS = "HOME$VALIDATION_WARNINGS",
  HOME$MOUNTING_GUIDE_LINK = "HOME$MOUNTING_GUIDE_LINK",
  HOME$DIAGNOSTICS = "HOME$DIAGNOSTICS",
  HOME$RUNTIME_INFO = "HOME$RUNTIME_INFO",
  HOME$CONFIG_INFO = "HOME$CONFIG_INFO",
  ...
  SETTINGS$RUNTIME_DOCKER = "SETTINGS$RUNTIME_DOCKER",
  SETTINGS$RUNTIME_LOCAL = "SETTINGS$RUNTIME_LOCAL",
  SETTINGS$RUNTIME_DESCRIPTION = "SETTINGS$RUNTIME_DESCRIPTION",
  SETTINGS$RESTART_REQUIRED = "SETTINGS$RESTART_REQUIRED",
  SETTINGS$RESTART_COMMAND = "SETTINGS$RESTART_COMMAND",
}
